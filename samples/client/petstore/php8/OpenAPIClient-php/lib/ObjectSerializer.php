...
class ObjectSerializer
{
     ...
     *
     * @return array|bool|float|int|object|string|null serialized form of $data
     */
    public static function sanitizeForSerialization(mixed $data, ?string $type = null, ?string $format = null): array|bool|float|int|object|string|null
    {
            ...
            if ($data instanceof ModelInterface) {
                ...
                foreach ($data::openAPITypes() as $property => $openAPIType) {
                    ...
                    if ($value !== null && !in_array(
                            $openAPIType,
                            [
                                'array', 'bool', 'double', 'float', 'int', 'mixed', 'object', 'string', 'void'
                            ],
                            true
                        )) {
