...
class MapTest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     */
    public function setMapMapOfString(?array $map_map_of_string): self
    {
     ...
     * @throws InvalidArgumentException
     */
    public function setMapOfEnumString(?array $map_of_enum_string): self
    {
     ...
     * @throws InvalidArgumentException
     */
    public function setDirectMap(?array $direct_map): self
    {
     ...
     * @throws InvalidArgumentException
     */
    public function setIndirectMap(?array $indirect_map): self
    {
