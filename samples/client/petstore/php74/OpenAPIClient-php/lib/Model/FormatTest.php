...
class FormatTest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    public function setInteger(?int $integer): self
    {
        if (!is_null($integer) && ($integer > 100)) {
            throw new InvalidArgumentException(
                'invalid value for $integer when calling FormatTest.setInteger, must be smaller than or equal to 100.'
            );
        }
        if (!is_null($integer) && ($integer < 10)) {
            throw new InvalidArgumentException(
                'invalid value for $integer when calling FormatTest.setInteger, must be bigger than or equal to 10.'
            );
        }
     ...
     * @throws InvalidArgumentException
     */
    public function setInt32(?int $int32): self
    {
        if (!is_null($int32) && ($int32 > 200)) {
            throw new InvalidArgumentException(
                'invalid value for $int32 when calling FormatTest.setInt32, must be smaller than or equal to 200.'
            );
        }
        if (!is_null($int32) && ($int32 < 20)) {
            throw new InvalidArgumentException(
                'invalid value for $int32 when calling FormatTest.setInt32, must be bigger than or equal to 20.'
            );
        }
     ...
     * @throws InvalidArgumentException
     */
    public function setInt64(?int $int64): self
    {
    ...
    public function setNumber($number): self
    {
        if (($number > 543.2)) {
            throw new InvalidArgumentException(
                'invalid value for $number when calling FormatTest.setNumber, must be smaller than or equal to 543.2.'
            );
        }
        if (($number < 32.1)) {
            throw new InvalidArgumentException(
                'invalid value for $number when calling FormatTest.setNumber, must be bigger than or equal to 32.1.'
            );
        }
    ...
    public function setFloat(?float $float): self
    {
        if (!is_null($float) && ($float > 987.6)) {
            throw new InvalidArgumentException(
                'invalid value for $float when calling FormatTest.setFloat, must be smaller than or equal to 987.6.'
            );
        }
        if (!is_null($float) && ($float < 54.3)) {
            throw new InvalidArgumentException(
                'invalid value for $float when calling FormatTest.setFloat, must be bigger than or equal to 54.3.'
            );
        }
     ...
     * @throws InvalidArgumentException
     */
    public function setDouble(?float $double): self
    {
        if (!is_null($double) && ($double > 123.4)) {
            throw new InvalidArgumentException(
                'invalid value for $double when calling FormatTest.setDouble, must be smaller than or equal to 123.4.'
            );
        }
        if (!is_null($double) && ($double < 67.8)) {
            throw new InvalidArgumentException(
                'invalid value for $double when calling FormatTest.setDouble, must be bigger than or equal to 67.8.'
            );
        }
     ...
     * @throws InvalidArgumentException
     */
    public function setDecimal(?Decimal $decimal): self
    {
    ...
    public function setString(?string $string): self
    {
        if (!is_null($string) && (!preg_match("/[a-z]/i", $string))) {
            throw new InvalidArgumentException(
                "invalid value for $string when calling FormatTest.setString, must conform to the pattern /[a-z]/i."
            );
        }
     ...
     * @throws InvalidArgumentException
     */
    public function setByte(string $byte): self
    {
     ...
     * @throws InvalidArgumentException
     */
    public function setBinary(?SplFileObject $binary): self
    {
    ...
    public function setPassword(string $password): self
    {
        if ((mb_strlen($password) > 64)) {
            throw new InvalidArgumentException(
                'invalid length for $password when calling FormatTest.setPassword, must be smaller than or equal to 64.'
            );
        }
        if ((mb_strlen($password) < 10)) {
            throw new InvalidArgumentException(
                'invalid length for $password when calling FormatTest.setPassword, must be bigger than or equal to 10.'
            );
        }
     ...
     * @throws InvalidArgumentException
     */
    public function setPatternWithDigits(?string $pattern_with_digits): self
    {
        if (!is_null($pattern_with_digits) && (!preg_match("/^\\d{10}$/", $pattern_with_digits))) {
            throw new InvalidArgumentException(
                "invalid value for $pattern_with_digits when calling FormatTest.setPatternWithDigits, must conform to the pattern /^\\d{10}$/."
            );
        }
     ...
     * @throws InvalidArgumentException
     */
    public function setPatternWithDigitsAndDelimiter(?string $pattern_with_digits_and_delimiter): self
    {
        if (!is_null($pattern_with_digits_and_delimiter) && (!preg_match("/^image_\\d{1,3}$/i", $pattern_with_digits_and_delimiter))) {
            throw new InvalidArgumentException(
                "invalid value for $pattern_with_digits_and_delimiter when calling FormatTest.setPatternWithDigitsAndDelimiter, must conform to the pattern /^image_\\d{1,3}$/i."
            );
        }
