...
public class Php74ClientCodegen extends AbstractPhpCodegen {
    @SuppressWarnings("hiding")
    private final Logger LOGGER = LoggerFactory.getLogger(Php74ClientCodegen.class);
    private final List<String> TYPES = Arrays.asList("array", "bool", "int", "float", "object", "string");

    public Php74ClientCodegen() {
        super();
        ...
        embeddedTemplateDir = templateDir = "php74";
    ...
    public String toSrcPath(final String packageName, final String basePath) {
        ...
        String packagePath = StringUtils.removeStart(
                // Replace period, backslash, forward slash with forward slash in package name
            ...
            if (modelTemplateList != null && !modelTemplateList.isEmpty()) {
                ...
                if (modelTemplate != null && modelTemplate.containsKey("model")) {
                    ...
                    for (CodegenProperty var : vars) {
                        ...
                        if ((var.dataType.equals("mixed") || var.dataType.contains("|")) && !(var.isArray || var.isMap)) {
                            // We are using this as a stand in for isMultiType,
                            // as in these cases php7.4 can't give these as type hints
                            var.isAnyType = true;
                        }
    ...
    public void postProcessParameter(CodegenParameter parameter) {
        ...
        if ((parameter.dataType.equals("mixed") || parameter.dataType.contains("|")) && !(parameter.isArray || parameter.isMap)) {
